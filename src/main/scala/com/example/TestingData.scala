...
object TestingData {
  ...
  SqliteDb.addHotel(0, Hotel("Coral Beach Resort Tiran", 1, 66600, 0.1, false, false, HotelsDetail(0, 0, "Worst hotel"), Array(PhotoUrl(0, 0,
    "https://s-ec.bstatic.com/images/hotel/max1024x768/147/147997361.jpg")), Seq(Review(0, 0, "2018-01-03", "Pharaoh", "sometext"))))
  SqliteDb.addHotel(1, Hotel("Try Me Beach", 1, 11100, 0.25, true, true, HotelsDetail(1, 1, "Death metal"), Array(PhotoUrl(1, 1,
  ...
  SqliteDb.addHotel(2, Hotel("Hilton", 2, 22200, 0.5, true, false, HotelsDetail(2, 2, "Hotel hotel hotel hotel hotel hotel hotel hotel hotel"), Array(PhotoUrl(2, 2,
  ...
  SqliteDb.addHotel(3, Hotel("Sheraton", 2, 33300, 1, false, true, HotelsDetail(3, 3, "Hotel hotel hotel hotel hotel hotel hotel hotel hotel"), Array(PhotoUrl(3, 3,
  ...
  SqliteDb.addHotel(4, Hotel("Westin", 3, 44400, 1.5, true, true, HotelsDetail(4, 4, "Hotel hotel hotel hotel hotel hotel hotel hotel hotel"), Array(PhotoUrl(4, 4,
  ...
  SqliteDb.addHotel(5, Hotel("Four Seasons", 3, 55500, 2, false, true, HotelsDetail(5, 5, "Hotel hotel hotel hotel hotel hotel hotel hotel hotel"), Array(PhotoUrl(5, 5,
  ...
  SqliteDb.addHotel(6, Hotel("Ritz-Carlton", 4, 66600, 2.5, false, false, HotelsDetail(6, 6, "Hotel hotel hotel hotel hotel hotel hotel hotel hotel"), Array(PhotoUrl(6, 6,
  ...
  SqliteDb.addHotel(7, Hotel("Hyatt", 4, 77700, 3, true, false, HotelsDetail(7, 7, "Hotel hotel hotel hotel hotel hotel hotel hotel hotel"), Array(PhotoUrl(7, 7,
    "https://t-ec.bstatic.com/images/hotel/max1024x768/388/38880764.jpg")), Seq(Review(7, 7, "1876-04-05", "Scorpion", "Get over here!!!"))))
  SqliteDb.addHotel(8, Hotel("Renaissance", 5, 88800, 3.5, true, true, HotelsDetail(8, 8, "Hotel hotel hotel hotel hotel hotel hotel hotel hotel"), Array(PhotoUrl(8, 8,
